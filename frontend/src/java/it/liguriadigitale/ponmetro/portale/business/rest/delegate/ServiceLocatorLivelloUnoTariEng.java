...
import it.liguriadigitale.ponmetro.portale.business.rest.util.ErrorResponseTariEngFilter;
...
public class ServiceLocatorLivelloUnoTariEng {

  protected Log log = LogFactory.getLog(getClass());

  private ResteasyClient client;

  public static ServiceLocatorLivelloUnoTariEng getInstance() {
    return new ServiceLocatorLivelloUnoTariEng();
  }
    ...
    try {
      ...
      client =
          new ResteasyClientBuilder()
              ...
              .register(ErrorResponseTariEngFilter.class)
  ...
  public void closeConnection() {
    if (client != null) {
      log.debug("[ServiceLocatorLivelloUnoTariEng] CHIUDO SOCKET HTTP");
      client.close();
    }
  }

...
import it.liguriadigitale.ponmetro.portale.business.rest.util.ErrorResponseMipGlobaliFilterRicevute;
...
public class ServiceLocatorLivelloUnoMipGlobaliRicevute extends ServiceLocatorLivelloUno {

  private ResteasyClient client;

  public static ServiceLocatorLivelloUnoMipGlobaliRicevute getInstance() {
    return new ServiceLocatorLivelloUnoMipGlobaliRicevute();
  }
    ...
    try {
      ...
      ResteasyClient client =
          new ResteasyClientBuilder()
              ...
              .register(ErrorResponseMipGlobaliFilterRicevute.class)

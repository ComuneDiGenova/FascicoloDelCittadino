...
public class ApiServiziPagamentiMipVerticaliTipologiaEntrata implements TipologiaEntrataApi {

  private TipologiaEntrataApi instance;

  public ApiServiziPagamentiMipVerticaliTipologiaEntrata(TipologiaEntrataApi instance) {

 ...
 * de.agilecoders.wicket.core.markup.html.bootstrap.button.BootstrapAjaxLink} that disables itself
 * during the Ajax call and shows a loading spinner
 */
public abstract class FdcLaddaAjaxLink<T> extends FdcBootstrapAjaxLink<T> {
   ...
   */
  public FdcLaddaAjaxLink(String id, Buttons.Type type) {
    super(id, type);
  }
   ...
   * @param type The Bootstrap type of the button
   */
  public FdcLaddaAjaxLink(String id, IModel<T> model, Buttons.Type type) {
    super(id, model, type);
  }
   ...
   */
  public <L extends Serializable> FdcLaddaAjaxLink(
   ...
   */
  public FdcLaddaAjaxLink<T> setEffect(LaddaBehavior.Effect effect) {
   ...
   * @return {@code this}, for chaining
   */
  public FdcLaddaAjaxLink<T> setSpinnerColor(String color) {
   ...
   * @return {@code this}, for chaining
   */
  public FdcLaddaAjaxLink<T> setSpinnerSize(int size) {

...
public abstract class FdcBootstrapAjaxLinkAutodichiarazione<T> extends AjaxLink<T>
    implements IBootstrapButton<FdcBootstrapAjaxLinkAutodichiarazione<T>> {

  private static final long serialVersionUID = 5490672807564144885L;
   ...
   */
  public FdcBootstrapAjaxLinkAutodichiarazione(final String id, final Buttons.Type type) {
    this(id, null, type);
  }
   ...
   * @param type the type of the button
   */
  public FdcBootstrapAjaxLinkAutodichiarazione(String id, IModel<T> model, Buttons.Type type) {
   ...
   */
  public <L extends Serializable> FdcBootstrapAjaxLinkAutodichiarazione(
   ...
   */
  public <L extends Serializable> FdcBootstrapAjaxLinkAutodichiarazione<T> setLabel(
      IModel<L> label) {
   ...
   * @return reference to the current instance
   */
  public FdcBootstrapAjaxLinkAutodichiarazione<T> setIconType(IconType iconType) {
  ...
  /** Sets the size. */
  @Override
  public FdcBootstrapAjaxLinkAutodichiarazione<T> setSize(Buttons.Size size) {
  ...
  /** Sets the type. */
  @Override
  public FdcBootstrapAjaxLinkAutodichiarazione<T> setType(Buttons.Type type) {
   ...
   */
  public FdcBootstrapAjaxLinkAutodichiarazione<T> useSplitter(boolean value) {
   ...
   * @return this instance for chaining
   */
  public FdcBootstrapAjaxLinkAutodichiarazione<T> setBlock(boolean block) {

...
public class ComuniTuttiAutoComplete<T> extends AutoCompleteTextField<T> {

  private static final long serialVersionUID = -2577791351037748148L;

  private Log log = LogFactory.getLog(getClass());

  @SuppressWarnings({"rawtypes", "unchecked"})
  public ComuniTuttiAutoComplete(String id, IModel modello) {
    super(id, modello);

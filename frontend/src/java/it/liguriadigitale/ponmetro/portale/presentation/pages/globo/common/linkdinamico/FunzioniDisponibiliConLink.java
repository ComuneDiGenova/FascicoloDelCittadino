 ...
 * 2021-09-23T15:54:38.409
 */
import it.liguriadigitale.ponmetro.api.pojo.links.CfgTCatFunzLink;
import java.io.Serializable;
import java.util.List;

public class FunzioniDisponibiliConLink implements Serializable {
  private static final long serialVersionUID = 1L;

  public FunzioniDisponibiliConLink() {
    super();
  }

  public List<CfgTCatFunzLink> cfgTCatFunzLink;

  public List<CfgTCatFunzLink> getCfgTCatFunzLink() {
    return cfgTCatFunzLink;
  }

  public void setCfgTCatFunzLink(List<CfgTCatFunzLink> cfgTCatFunzLink) {
  ...
  private String iconaCss;

  private String idFunzPadre;

  private String path;

  private String classePaginaStdPadre;
  ...
  public String getClassePaginaStdPadre() {
    return classePaginaStdPadre;
  }

  public void setClassePaginaStdPadre(String classePaginaStdPadre) {
    this.classePaginaStdPadre = classePaginaStdPadre;
  }

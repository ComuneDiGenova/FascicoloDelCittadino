 ...
 */
package it.liguriadigitale.ponmetro.portale.presentation.components.select2.json;

import org.json.JSONWriter;

/**
 * A JSONWriter that writes and allows access to the underlying {@link StringBuilder}. One of the
 * advantages of this class is that it can expose Json as a {@link CharSequence} instead of a {@link
 * String} so no extra memory allocations are necessary for code that can use a {@link
 * CharSequence}.
 *
 * @author igor
 */

...
public class WidgetDinamico extends MyWidgetPanel {

  private static final long serialVersionUID = -5219415438683741620L;

  private DatiVisualizzazioneSezioneWidget widget;

  public WidgetDinamico(POSIZIONE posizione, DatiVisualizzazioneSezioneWidget widget) {
    super(posizione);
    this.widget = widget;
    fillDati("");
    ...
    LaddaAjaxLink<Object> linkImg =
        new LaddaAjaxLink<Object>("linkImg", Type.Link) {
          ...
          public void onClick(AjaxRequestTarget target) {
            target.add(WidgetDinamico.this);
            Class clazz = getComponentPage(widget.getFunzione().getClassePagina());

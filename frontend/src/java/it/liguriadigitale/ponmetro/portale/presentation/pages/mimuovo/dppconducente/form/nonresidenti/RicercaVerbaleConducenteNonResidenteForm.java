package it.liguriadigitale.ponmetro.portale.presentation.pages.mimuovo.dppconducente.form.nonresidenti;
...
public class RicercaVerbaleConducenteNonResidenteForm
    extends AbstracFrameworkForm<RicercaVerbaleConducente> {

  private static final long serialVersionUID = 1733018131763500972L;
  ...
  public RicercaVerbaleConducenteNonResidenteForm(
  ...
  public void addElementiForm(Utente utente) {
    ...
    TextField cittaNascitaConducente =
        new TextField(
            "cittaNascitaConducente",
            new PropertyModel(getModelObject(), "cittaNascitaConducente"));
    cittaNascitaConducente.setRequired(true);
    cittaNascitaConducente.setLabel(Model.of("Conducente nato a"));
    addOrReplace(cittaNascitaConducente);

    TextField provinciaNascitaConducente =
        new TextField(
            "provinciaNascitaConducente",
            new PropertyModel(getModelObject(), "provinciaNascitaConducente"));
    provinciaNascitaConducente.setRequired(true);
    provinciaNascitaConducente.setLabel(Model.of("Provincia conducente"));
    addOrReplace(provinciaNascitaConducente);

    TextField indirizzoConducente =
        new TextField(
            "indirizzoConducente", new PropertyModel(getModelObject(), "indirizzoConducente"));
    indirizzoConducente.setRequired(true);
    indirizzoConducente.setLabel(Model.of("Indirizzo conducente"));
    addOrReplace(indirizzoConducente);

    TextField cittaConducente =
        new TextField("cittaConducente", new PropertyModel(getModelObject(), "cittaConducente"));
    cittaConducente.setRequired(true);
    cittaConducente.setLabel(Model.of("Citta' conducente"));
    addOrReplace(cittaConducente);

    TextField capConducente =
        new TextField("capConducente", new PropertyModel(getModelObject(), "capConducente"));
    capConducente.setRequired(true);
    capConducente.setLabel(Model.of("Cap conducente"));
    ...
    emailDichiarante.add(
        new OnChangeAjaxBehaviorSenzaIndicator() {
          ...
          private static final long serialVersionUID = -638757865085718311L;
    ...
    formInterno =
        new Form<Void>("formUpload") {

          private static final long serialVersionUID = -2675308877142162224L;
        };
    formInterno.add(
        new AjaxFormSubmitBehavior("change") {

          private static final long serialVersionUID = -4866116167662928995L;
            ...
            if (uploadedFile != null) {
              ...
              AjaxButton eliminaFile =
                  new AjaxButton("eliminaFile") {
                    ...
                    private static final long serialVersionUID = 3752875398328440381L;

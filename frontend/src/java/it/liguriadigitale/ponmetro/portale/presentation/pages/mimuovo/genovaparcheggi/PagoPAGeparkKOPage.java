...
public class PagoPAGeparkKOPage extends LayoutNoFeedBackPage {

  private static final long serialVersionUID = -7500150767079570649L;

  public PagoPAGeparkKOPage() {
    ...
    List<MessaggiInformativi> listaMessaggi =
        ServiceLocator.getInstance().getServiziGenovaParcheggi().popolaListaMessaggiKO();

...
public class CampoCasellaControllo extends CheckGroup<String> implements InvalidForceable {

  private static final long serialVersionUID = 620587439082551355L;

  private boolean invalidForced;

  public CampoCasellaControllo(String nomeCampo, IModel<String> model) {
    super(nomeCampo);

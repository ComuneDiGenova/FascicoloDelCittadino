package it.liguriadigitale.ponmetro.portale.presentation.pages.domandalocazione.panel;
...
public class DomandeLocazionePanel extends BasePanel {
  ...
  public DomandeLocazionePanel(String id, V1BandoDomandeViewFullDOM dettaglio) {
    super(id);
  ...
  public void fillDati(Object dati) {
    ...
    elemDettaglio.addOrReplace(
        new AmtCardLabel<>("statoDomanda", statoDomanda, DomandeLocazionePanel.this));
    elemDettaglio.addOrReplace(
        new AmtCardLabel<>("descrizioneStato", descrizioneStato, DomandeLocazionePanel.this));
    elemDettaglio.addOrReplace(
        new AmtCardLabel<>("dataPresentazione", dataPresentazione, DomandeLocazionePanel.this));
    elemDettaglio.addOrReplace(
        new AmtCardLabel<>("numeroProtocollo", numeroProtocollo, DomandeLocazionePanel.this));
    elemDettaglio.addOrReplace(
        new AmtCardLabel<>("dataProtocollo", dataProtocollo, DomandeLocazionePanel.this));
  ...
  private BottoneAJAXDownloadWithError creaDownloadRicevuta(String idBandoDomande) {
    BottoneAJAXDownloadWithError btnScaricaRicevuta =
        new BottoneAJAXDownloadWithError("btnScaricaRicevuta", DomandeLocazionePanel.this) {

          private static final long serialVersionUID = -5006717292269343941L;

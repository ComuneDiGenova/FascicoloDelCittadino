...
public class DichiarazionePuntiPatenteProprietarioForm
    extends AbstracFrameworkForm<PuntiPatenteProprietario> {

  private static final long serialVersionUID = 4094539867482740971L;
  ...
  public DichiarazionePuntiPatenteProprietarioForm(
  ...
  public void addElementiForm(Utente utente) {
    ...
    if (visibilitaProprietario) {
      ...
      containerDatiProprietario.setVisible(false);
      containerDatiConducente.setVisible(true);
    }

    radioProprietario.setOutputMarkupId(true);
    radioProprietario.setOutputMarkupPlaceholderTag(true);

    radioProprietario.add(
        new AjaxFormChoiceComponentUpdatingBehavior() {

          private static final long serialVersionUID = -5824182109258387099L;
          ...
          protected void onUpdate(AjaxRequestTarget target) {
            if (radioProprietario.getInput().equalsIgnoreCase("true")) {
              ...
              containerDatiProprietario.setVisible(false);
              containerDatiConducente.setVisible(true);
              containerDatiProprietario.clearOriginalDestination();
            ...
            target.add(DichiarazionePuntiPatenteProprietarioForm.this, feedbackPanel);
          }
    ...
    formUploadProprietario =
        new Form<Void>("formUploadProprietario") {
          ...
          private static final long serialVersionUID = 7114585238671254849L;
    ...
    formUploadProprietario.add(
        new AjaxFormSubmitBehavior("change") {
          ...
          private static final long serialVersionUID = -6729394716514363518L;
    ...
    containerDatiProprietario.addOrReplace(formUploadProprietario);
    ...
    formUploadConducente =
        new Form<Void>("formUploadConducente") {
          ...
          private static final long serialVersionUID = 2957839790731931508L;

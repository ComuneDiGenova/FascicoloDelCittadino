...
public class FdCTextFieldCurrency<T extends Component> extends Panel {

  private static final long serialVersionUID = -5197932571565619851L;
  ...
  //		this.textField.setEnabled(required);
  //	}

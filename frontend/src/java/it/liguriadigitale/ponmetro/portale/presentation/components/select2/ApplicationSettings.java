 ...
 *
 * <p>The settings object is retreived via the static {@link #get()} method and is usually
 * configured in the {@link WebApplication#init()} method.
 *
 * @author igor
 */
public class ApplicationSettings {

  private static final MetaDataKey<ApplicationSettings> KEY =
      new MetaDataKey<ApplicationSettings>() {};

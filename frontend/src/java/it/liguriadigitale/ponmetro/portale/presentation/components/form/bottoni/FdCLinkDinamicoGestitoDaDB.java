...
public class FdCLinkDinamicoGestitoDaDB<T> extends Panel {
  ...
  public FdCLinkDinamicoGestitoDaDB(
      String id,
  ...
  public FdCLinkDinamicoGestitoDaDB(String id, LinkDinamicoFunzioneData linkF, T t) {
    this(id, linkF, t, null, null, true);
  }

  public FdCLinkDinamicoGestitoDaDB(String id, LinkDinamicoFunzioneData linkF) {
  ...
  private void creaLink(LinkDinamicoFunzioneData linkF, T t, Component component, String iconaCss) {
    ...
    /*
    		IconType iconType = new IconType("linkNoDImg") {
    ...
    */
    ...
    AttributeModifier attributeModifier = new AttributeModifier("class", "dropdown-item");

...
public class LinkDinamicoFunzioneBolloAuto<T> extends Panel {

  private static final long serialVersionUID = -7048969202013149266L;
  ...
  public LinkDinamicoFunzioneBolloAuto(
  ...
  public LinkDinamicoFunzioneBolloAuto(String id, LinkDinamicoFunzioneData linkF, T t) {
    this(id, linkF, t, null);
  }

  public LinkDinamicoFunzioneBolloAuto(String id, LinkDinamicoFunzioneData linkF) {
    ...
    link =
        new Link<Void>(LINK_ID) {
          ...
          public void onClick() {
            try {
              log.debug(
                  ":: LinkDinamicoFunzioneBolloAuto > creaLink > onClick : cerco classe "
              ...
              log.debug(
                  ":: LinkDinamicoFunzioneBolloAuto > creaLink > onClick : class "
                      + linkF.getWicketClassName()
                      + " trovata ");
              if (t != null) {
              ...
              log.error(
                  "[LinkDinamicoFunzioneBolloAuto1] onClick error on reflection: " + e.getMessage(),
                  e);
            } catch (IllegalAccessException e) {
              log.error(
                  "[LinkDinamicoFunzioneBolloAuto2] onClick error on reflection: " + e.getMessage(),
                  e);
            } catch (IllegalArgumentException e) {
              log.error(
                  "[LinkDinamicoFunzioneBolloAuto3] onClick error on reflection: " + e.getMessage(),
                  e);
              ...
              log.error(
                  "[LinkDinamicoFunzioneBolloAuto4] onClick error on reflection: "
                      + e1.getMessage(),
                  e);
              throw new RestartResponseException(new BolloAutoErroriPage(e1.getMessage()));
            } catch (NoSuchMethodException e) {
              log.error(
                  "[LinkDinamicoFunzioneBolloAuto5] onClick error on reflection: " + e.getMessage(),
                  e);
            } catch (SecurityException e) {
              log.error(
                  "[LinkDinamicoFunzioneBolloAuto6] onClick error on reflection: " + e.getMessage(),
                  e);
            }
          }
